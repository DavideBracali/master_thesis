...
sliding window instead of a non-overlapping one. One must however keep in mind
that, for each time frame, a different network has to be built and the
computation time to build and extract features will scale linearly with the
