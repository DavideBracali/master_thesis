...
!!!! La mettiamo questa sezione???? I pattern comuni sono abbastanza pochi e 
gli onset sono molto diversi
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Immagini/example/DE/tr_lanent_space.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Immagini/example/DE/tr_gmm.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Immagini/example/DE/tr_gmm_test.png}
...
The ranking of suspicious contacts is shown in Figure \ref{fig:exDE:alarm}.

\begin{figure}[H]
    \centering
    \includegraphics[width=1.2\textwidth]{Immagini/example/DE/alarm.pdf}
