...
\begin{figure}[H]
    ...
    %!!! sostituire immagine con nuovo titolo
\end{figure}
...
The ranking of the top 50 suspicious contacts is shown in Figure
\ref{fig:exDE:alarm}.
...
\begin{figure}[H]
    ...
    \caption{!!! Come mai non è centrato? Cambiare immagine, mostrare magari i top 30}
\end{figure}
...
\begin{tabular}{lcc}
\hline
\textbf{TRAINING SET} & \textbf{Median} & \textbf{IQR} \\
\hline
Precision           & $0.620$ & $[0.223,0.857]$  \\
Specificity         & $0.973$ & $[0.918, 0.997]$ \\
Balanced Accuracy   & $0.613$ & $[0.534, 0.680]$ \\
ROC-AUC             & $0.827$ & $[0.613, 0.859]$ \\
\hline
\end{tabular}
\end{subtable}
\hfill
...
\begin{tabular}{lcc}
\hline
\textbf{VALIDATION SET} & \textbf{Median} & \textbf{IQR} \\
\hline
Precision           & $0.667$ & $[0.237, 0.894]$  \\
Specificity         & $0.968$ & $[0.927, 0.997]$ \\
Balanced Accuracy   & $0.624$ & $[0.555, 0.672]$ \\
ROC-AUC             & $0.827$ & $[0.640, 0.873]$ \\
\hline
\end{tabular}
\end{subtable}
...
\textbf{TRAINING SET} & \textbf{Median} & \textbf{IQR} \\
\hline
Precision           & $0.714$ & $[0.417, 0.821]$  \\
Specificity         & $0.980$ & $[0.933, 0.989]$ \\
Balanced Accuracy   & $0.628$ & $[0.548, 0.674]$ \\
ROC-AUC             & $0.796$ & $[0.627, 0.841]$ \\
\hline
\end{tabular}
\end{subtable}
\hfill
...
\begin{tabular}{lcc}
\hline
\textbf{TEST SET} & \textbf{Median} & \textbf{IQR} \\
\hline
Precision           & $0.172$ & $[0.152, 0.215]$  \\
Specificity         & $0.846$ & $[0.800, 0.875]$ \\
Balanced Accuracy   & $0.652$ & $[0.593, 0.691]$ \\
ROC-AUC             & $0.722$ & $[0.579, 0.796]$ \\
\hline
\end{tabular}
\end{subtable}
\caption{Evaluation metrics on validation patients.}
\label{tab:eval_test}
\end{table}
...
This result is "rafforzato" by the fact that the VAE encoding of resting-state 
