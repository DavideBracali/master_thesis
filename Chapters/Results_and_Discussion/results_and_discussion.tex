...
$L=0$, both for the final training and across all training folds during
cross-validation. 
...
data, as feeding a moderate number of patients to the encoder proved to result 
in a sparse latent space that wrongfully detects atypical behavior even in
